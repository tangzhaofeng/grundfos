...
Parsley.addMessages('en', {
  ...
  required:       weui_icon_warn+"输入值不能为空",
...
// Parsley.setLocale('en');
  ...
  // Parsley.addMessages('en', {
  //   defaultMessage: weui_icon_warn+"This value seems to be invalid.",
  //   type: {
  //     email: weui_icon_warn+"This value should be a valid email.",
  //     url: weui_icon_warn+"This value should be a valid url.",
  //     number: weui_icon_warn+"This value should be a valid number.",
  //     integer: weui_icon_warn+"This value should be a valid integer.",
  //     digits: weui_icon_warn+"This value should be digits.",
  //     alphanum: weui_icon_warn+"This value should be alphanumeric."
  //   },
  //   notblank: weui_icon_warn+"This value should not be blank.",
  //   required: weui_icon_warn+"This value is required.",
  //   pattern: weui_icon_warn+"This value seems to be invalid.",
  //   min: weui_icon_warn+"This value should be greater than or equal to %s.",
  //   max: weui_icon_warn+"This value should be lower than or equal to %s.",
  //   range: weui_icon_warn+"This value should be between %s and %s.",
  //   minlength: weui_icon_warn+"This value is too short. It should have %s characters or more.",
  //   maxlength: weui_icon_warn+"This value is too long. It should have %s characters or fewer.",
  //   length: weui_icon_warn+"This value length is invalid. It should be between %s and %s characters long.",
  //   mincheck: weui_icon_warn+"You must select at least %s choices.",
  //   maxcheck: weui_icon_warn+"You must select %s choices or fewer.",
  //   check: weui_icon_warn+"You must select between %s and %s choices.",
  //   equalto: weui_icon_warn+"This value should be the same."
  // });
