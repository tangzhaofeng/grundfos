...
class AccessToken{
    ...
    private static function _getAccessToken(){
        $url = 'https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid='.\weChatConfig::getAppId("appId").'&secret='.\weChatConfig::getAppId("appSecret");
         ...
         */
        $f = fopen(\weChatConfig::getAppId("appId").'access_token', 'w+');
    ...
    private static function _checkAccessToken(){
        ...
        //\weChatConfig::getAppId("appId") 为该公众号的前缀以区分 当前公众号的access_token
        $data = file_get_contents(\weChatConfig::getAppId("appId").'access_token');
