...
$config = array(
    ...
    'default-sp-test' => array(
        ...
        'idp' => 'http://fs.pptplus.cn/adfs/services/trust',

        // The URL to the discovery service.
        // Can be NULL/unset, in which case a builtin discovery service will be used.
        //the url to the discovery service
        'discoURL' => null,
        //ADFS 2012R2 requires signing of logout
        //'sign.logout' => TRUE,
        //'redirect.sign' => TRUE,
        ...
        //'signature.algorithm' => 'https://www.w3.org/2001/04/xmldsig-more#rsa-sha256'
    ),
